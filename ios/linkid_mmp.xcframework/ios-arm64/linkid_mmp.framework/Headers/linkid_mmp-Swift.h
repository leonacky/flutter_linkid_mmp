...
@class NSCoder;
SWIFT_CLASS("_TtC10linkid_mmp13AirflexAdView")
@interface AirflexAdView : UIView
...
@interface AirflexAdView (SWIFT_EXTENSION(linkid_mmp)) <UIPageViewControllerDataSource>
